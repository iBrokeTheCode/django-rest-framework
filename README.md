...
3. [Django REST Framework - Nested Serializers, SerializerMethodField and Serializer Relations](./notes/lesson-03.md)
4. [Django REST Framework - Serializer subclasses and Aggregated API data](./notes/lesson-04.md)
5. [django-silk for Profiling and Optimization with Django REST Framework](./notes/lesson-05.md)
6. [Django REST Framework - Generic Views | ListAPIView & RetrieveAPIView](./notes/lesson-06.md)
7. [Django REST Framework - Dynamic Filtering | Overriding get_queryset() method](./notes/lesson-07.md)
8. [Django REST Framework - Permissions and Testing Permissions](./notes/lesson-08.md)
9. [Django REST Framework - APIView class](./notes/lesson-09.md)
10. [Django REST Framework - Creating Data | ListCreateAPIView and Generic View Internals](./notes/lesson-10.md)
11. [Django REST Framework - Customising permissions in Generic Views | VSCode REST Client extension](./notes/lesson-11.md)
12. [Django REST Framework - JWT Authentication with djangorestframework-simplejwt](./notes/lesson-12.md)
13. [Django REST Framework - Refresh Tokens & JWT Authentication](./notes/lesson-13.md)
14. [Django REST Framework - Updating & Deleting data](./notes/lesson-14.md)
15. [drf-spectacular - Django REST Framework API Documentation](./notes/lesson-15.md)
16. [django-filter and DRF API filtering - Django REST Framework](./notes/lesson-16.md)
17. [SearchFilter and OrderingFilter in Django REST Framework](./notes/lesson-17.md)
18. [Writing Filter Backends in Django REST Framework!](./notes/lesson-18.md)
19. [API Pagination - Django REST Framework | PageNumberPagination & LimitOffsetPagination](./notes/lesson-19.md)
20. [Viewsets & Routers in Django REST Framework](./notes/lesson-20.md)
21. [Viewset Actions, Filtering and Permissions in Django REST Framework](./notes/lesson-01.md)
22. [Viewset Permissions | Admin vs. Normal User in Django](./notes/lesson-22.md)
23. [Creating Nested Objects | Overriding serializer create() method in Django REST Framework](./notes/lesson-23.md)
24. [Updating Nested Objects | ModelSerializer update() method in Django REST Framework](./notes/lesson-24.md)
25. [ModelSerializer Fields - Best Practices](./notes/lesson-25.md)
26. [Caching with Redis and Django!](./notes/lesson-26.md)
27. [Django & Redis - Vary Headers to Control Caching Behavior](./notes/lesson-27.md)
28. [API Throttling with Django REST Framework](./notes/lesson-28.md)
29. [Testing APIs with Django REST Framework](./notes/lesson-29.md)
30. [Celery tasks with Django REST Framework!](./notes/lesson-30.md)
